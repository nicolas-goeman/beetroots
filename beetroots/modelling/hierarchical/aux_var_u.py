...
class AuxiliaryGivenTarget(Hierarchical):
    r"""Class implementing the auxiliary variable :math:`u` for the conditional distribution :math:`\pi(U|\Theta, Y)`."""
    ...
    def neglog_pdf(
        ...
        out += xp.square(nlpdf_utils['log_aux'] + nlpdf_utils['s_m2']/2 - forward_map_evals['log_f_Theta'])/(2*nlpdf_utils['s_m2'])
    ...
    def gradient_neglog_pdf_wrt_aux(
        ...
        out += 3/2 + (nlpdf_utils['log_aux'] - forward_map_evals['log_f_Theta'])/nlpdf_utils['s_m2']
        out /= nlpdf_utils['aux']
    ...
    def gradient_neglog_pdf_wrt_target(
        ...
        out -= forward_map_evals['grad_log_f_Theta']*(nlpdf_utils['log_aux'] + nlpdf_utils['s_m2']/2 - forward_map_evals['log_f_Theta'])
        out /= nlpdf_utils['s_m2']
    ...
    def hess_diag_neglog_pdf_wrt_aux(
        ...
        out += 3/2 + (nlpdf_utils['log_aux'] - forward_map_evals['log_f_Theta']- 1)/nlpdf_utils['s_m2']
    ...
    def hess_diag_neglog_pdf_wrt_target(
        ...
        out += forward_map_evals['hess_diag_log_f_Theta']*(nlpdf_utils['log_aux'] + nlpdf_utils['s_m2']/2 - forward_map_evals['log_f_Theta'])
...
class TargetGivenAuxiliary(Hierarchical):
    r"""Class implementing the auxiliary variable :math:`u` for the conditional distribution :math:`\pi(U|\Theta, Y)`."""
